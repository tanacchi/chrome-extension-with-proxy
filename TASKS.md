...
### 1.1 アーキテクチャ設計
- [ ] 全体ディレクトリ構成の検討
- [ ] 実装方針の決定（TDD、小さなステップでの実装）
- [ ] 技術スタック詳細の確認（AI SDK、OpenAI統合方法）
- [ ] データフロー設計（テーブル→抽出→API→表示）
- [ ] 設計書レビュー依頼・承認

### 1.2 開発環境準備
- [ ] 依存関係の追加検討（@ai-sdk/react, @ai-sdk/openai等）
- [ ] package.jsonの更新方針決定
- [ ] 開発・テスト用サーバー構成の設計
- [ ] 環境構築手順の整理
...
- [ ] サンプルHTMLサーバーのテスト作成
- [ ] サンプルHTMLサーバーの実装
- [ ] 3x3テーブルのHTMLテンプレート作成
- [ ] 適切なクラス名設定の確認
- [ ] サンプルHTMLサーバーの動作テスト

### 2.2 モックAPIサーバー
- [ ] モックAPIサーバーのテスト作成
- [ ] OpenAI API準拠のレスポンス形式調査
- [ ] モックAPIサーバーの実装
- [ ] 入力30文字利用の簡易レスポンス実装
- [ ] モックAPIサーバーの動作テスト
...
- [ ] AISettings型定義のテスト作成
- [ ] AISettings型定義の実装
- [ ] AnalysisResult型定義のテスト作成
- [ ] AnalysisResult型定義の実装
- [ ] ストレージヘルパー関数のテスト作成
- [ ] ストレージヘルパー関数の実装
- [ ] ストレージ機能の動作テスト
