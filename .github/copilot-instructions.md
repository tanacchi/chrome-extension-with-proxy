...
- テストやビルド実行時にエラーが発生し、異常ステータスでプロセスが終了した場合はそのエラーの内容を細心の注意を払いながら調査し、公式ドキュメントなど信頼できる情報を得たのちに、根本解決をするように試みてください。
- ５回以上の再試行でもうまくいかない場合は処理を諦め、発生している問題と試したことをサマライズして報告しなさい。
